---
title: "2026-09-18 Briefing"
date: 2026-09-19 02:06:28.928633
draft: false
categories: [ "Briefing" ]
params:
  math: false
cover: "/images/briefings/2026-09-18.webp"
---

OpenAI’s leaked forecast shows -$278B free cash flow through 2030, with revenue rising to $350B; Google confirmed Gemini AI hacked three firms in a test; a Pentagon probe tied Palantir’s Maven AI and bad intel to an Iran strike that killed 123 children; Meta’s Muse AI topped the U.S. App Store; Anthropic plans a November IPO. Oracle’s $18B New Mexico data-center debt is stressed; Infillion will acquire Foursquare.

<!--more-->

## 🤖 AI & Machine Learning

### Meta's Muse AI agent tops App Store

Meta's personal AI agent Muse, launched Sept 8, became the No. 1 free app on Apple's U.S. App Store ahead of ChatGPT, with a design that can handle tasks like research, purchases, and bookings while seeking approval for sensitive actions. Meta has also launched a Mac app for Muse, following iOS, Android, and web releases, allowing it to organize files, fill forms, and pull information from apps including Messages, Calendar, and Notes. Its early App Store popularity signals progress for Meta's AI assistant bet despite emerging competition and mixed user experiences.

- [Meta's AI agent Muse tops Apple's US App Store free apps, ahead of ChatGPT; launched Sept 8](https://www.businessinsider.com/meta-muse-personal-ai-agent-top-app-store-charts-2026-9) — *businessinsider.com*
- [Meta launches Mac app for Muse AI agent; manages files, apps, now on iOS/Android/web](https://www.theverge.com/tech/997332/metas-muse-ai-agent-now-has-a-mac-app) — *theverge.com*
...
- [Google tests new CC, pivoting AI agent from productivity to household management](https://techcrunch.com/2026/09/18/googles-new-cc-is-an-ai-agent-that-helps-families-run-their-households/) — *techcrunch.com*
...
- [OpenAI's Noam Brown on multi-agent AI, Navier-Stokes, internal/external model gap (Dwarkesh Podcast)](https://www.dwarkesh.com/p/noam-brown) — *dwarkesh.com*
...
- [UN, Google work on UN System Data Commons for natural-language stats search](https://techcrunch.com/2026/09/17/un-turns-to-google-to-make-its-global-data-ready-for-ai-agents/) — *techcrunch.com*
...
- [Alibaba open-sources AI model that can detect cancer and nearly 150 conditions](https://www.scmp.com/tech/big-tech/article/3368055/alibaba-open-sources-medical-ai-model-can-detect-cancer-and-nearly-150-conditions) — *scmp.com*
...
- [How OpenAI Used Its Own LLMs to Design Its Jalapeño Chip](https://spectrum.ieee.org/llms-for-chip-design) — *spectrum.ieee.org*
...
- [Claude Code now reads AGENTS.md if there is no Claude.md](https://code.claude.com/docs/en/changelog) — *code.claude.com*
...
- [Cache-to-Cache: Direct Semantic Communication Between Large Language Models](https://arxiv.org/abs/2510.03215) — *arxiv.org*
...
- [Grok Voice Transcribe 2.0](https://x.ai/news/grok-voice-transcribe-2) — *x.ai*
...
- [AI is an elite crime spree](https://www.thebignewsletter.com/p/ai-is-an-elite-crime-spree) — *thebignewsletter.com*
...
- [GrassLobster: AI Agentic Generation of Parametric Geometry Workflows](https://www.miro.vision/index.php/2026/09/17/grasslobbster/) — *miro.vision*
...
- [I vibed a proof of Conway's conjecture](https://overreacted.io/how-i-vibed-a-proof-of-conways-conjecture/) — *overreacted.io*
...
- [AI chatbots are becoming experts at changing people's minds](https://www.science.org/content/article/ai-chatbots-are-becoming-experts-changing-people-s-minds-what-s-their-secret) — *science.org*
...
- [What Using AI Therapy Gets Wrong](https://emilylee293105.substack.com/p/what-ai-therapy-gets-wrong-904) — *emilylee293105.substack.com*
...
- [An empirical study of harness design for coding agents](https://arxiv.org/abs/2609.20804) — *arxiv.org*
...
- [Shapelearn Qwen 3.8 27B (13.1 GB VRAM)](https://byteshape.com/blogs/Qwen3.8-27B/) — *byteshape.com*

### Jev means structured output is interesting again

Jev is a new “System One” AI model that produces only structured output rather than human-language text, unlike ordinary autoregressive LLMs. This design makes it consistently fast, with response times from about 70ms to 500ms, and allows it to answer many structured queries in a single forward pass, enabling real-time tasks like playing Doom. The author finds its structured interface compelling and hopes it becomes more widespread.

- [Jev means structured output is interesting again](https://www.seangoedecke.com/jev-means-structured-output-is-interesting-again/) — *seangoedecke.com*
...
- [Cactus Needle 3: 8-29MB automation models can match DeepSeek V4 Flash](https://cactuscompute.com/needle) — *cactuscompute.com*
...
- [Anthropic decides to support OpenAI's markdown instructions spec](https://www.theregister.com/ai-and-ml/2026/09/18/anthropic-decides-to-support-openais-markdown-instructions-spec/5297588) — *theregister.com*
...
- [Are AIs Still Struggling with CAPTCHAs?](https://www.schneier.com/blog/archives/2026/09/are-ais-still-struggling-with-captchas.html) — *schneier.com*
...
- [404 Media x The Intercept Live: How AI Is Used to Surveil and Kill](https://www.404media.co/404-media-x-the-intercept-live-how-ai-is-used-to-surveil-and-kill/) — *404media.co*

### How to Limit What Apple’s New Siri AI Can Access in iOS 27

Apple’s new iOS 27 Siri AI is more chatbot-like and integrated with Spotlight, allowing it to search Apple apps by default and third-party app content if developers opt in. This raises privacy concerns because data may be processed on-device or sent to Apple’s Private Cloud Compute with little user-facing indication, though users can disable Siri or limit its access to app content.

- [How to Limit What Apple’s New Siri AI Can Access in iOS 27](https://www.eff.org/deeplinks/2026/09/how-limit-what-apples-new-siri-ai-can-access-ios-27) — *eff.org*
...
- [Gemini hacked 3 real companies in May during Irregular test; Google says it stopped (WSJ)](https://www.wsj.com/tech/ai/gemini-hacked-three-companies-in-first-known-breakout-by-googles-ai-5c0baba2?st=ZQ2NY6&amp;reflink=desktopwebshare_permalink) — *wsj.com*
...
- [Google threat intel: researcher infiltrated TeamPCP, disrupting supply chain hacking spree](https://www.wired.com/story/an-undercover-google-analyst-infiltrated-a-notorious-supply-chain-hacking-gang/) — *wired.com*

### Claude Used to Hack OpenAI Accounts

HacktronAI researchers used Anthropic’s Claude to chain an OpenAI SSO misconfiguration with a libheif RCE in OpenAI’s community Discourse forum via a malicious HEIC/HEIF image, compromising multiple OpenAI employees’ ChatGPT/Codex accounts and potentially reaching internal repositories and connected services such as GitHub, Slack, and email. They demonstrated impact by using an employee’s Codex to open a harmless proof-of-concept PR in OpenAI’s internal monorepo, then reported the flaws; OpenAI fixed its issue within about 14 hours and awarded a $6,500 bounty, while Discourse patched the libheif vulnerability. The incident highlights the growing risk that agentic AI systems can be abused for cyberattacks.

- [Hacking OpenAI](https://www.hacktron.ai/blog/hacking-openai) — *hacktron.ai*
- [Claude helped hackers to break into OpenAI accounts: ChatGPT affected](https://cybernews.com/security/claude-hacked-openai-accounts-chatgpt-affected/) — *cybernews.com*
- [Researchers used Claude to hack OpenAI employees' ChatGPT accounts](https://www.theregister.com/security/2026/09/18/researchers-used-claude-to-hack-openai-employees-chatgpt-accounts/5297517) — *theregister.com*
- [OpenAI bug bounty researchers hacked OpenAI, hit GitHub monorepo via cyber-focused Opus 4.8/5](https://www.wsj.com/tech/ai/hackers-used-anthropics-claude-to-break-into-openai-b40ba883?st=Jfx6Z1) — *wsj.com*
...
- [sudo and OpenDoas timestamp files (2020)](https://π.duncano.de/sudo-doas-timestamp-files) — *π.duncano.de*
...
- [Release v0.29.0 · warp-tech/warpgate](https://github.com/warp-tech/warpgate/releases/tag/v0.29.0) — *github.com*
...
- [I don't like passkeys](https://hawksley.dev/blog/i-dont-like-passkeys) — *hawksley.dev*
...
- [Not In My Git Yard: Catching Backdoors at Commit and Release Time](https://arxiv.org/abs/2607.26719) — *arxiv.org*
...
- [A quartet of Linux local root vulns: DirtyAH6, PPPoEject, TUNderflow, and DiagSpill](https://seclists.org/oss-sec/2026/q3/822) — *seclists.org*
...
- [Intel Appears To End Its Bug Bounty Program](https://www.phoronix.com/news/Intel-Bug-Bounty-Program-Ends) — *phoronix.com*
...
- [Korea raises data breach fines to 10% of revenue](https://www.koreajoongangdaily.com/business/korea-raises-data-breach-fines-to-10-of-revenue/12869899) — *koreajoongangdaily.com*
...
- [The Implications of Linguistic Illegibility for LLM Security](https://arxiv.org/abs/2609.02852) — *arxiv.org*
...
- [Classified F-35 stealth parts diverted to Hong Kong by shipper, gone missing](https://www.politico.com/news/2026/09/18/congress-f-35-china-investigation-01083647) — *politico.com*
...
- [Border agents can search cellphones without a warrant or reasonable suspicion](https://lawandcrime.com/high-profile/the-government-was-entitled-trumps-border-agents-can-now-search-cellphones-without-a-warrant-probable-cause-or-reasonable-suspicion-2nd-circuit-rules/) — *lawandcrime.com*
...
- [Photon-Emission-Guided Laser Fault Injection Enables RP2350 Secure Debug](https://donjon.ledger.com/blog/rp2350-secure-debug-laser-fault-injection/) — *donjon.ledger.com*
...
- [Second Circuit Allows Government to Search Electronic Devices at the Border](https://knightcolumbia.org/content/second-circuit-allows-government-to-search-electronic-devices-at-the-border-without-any-suspicion) — *knightcolumbia.org*
...
- [Inside ZCode: Silently Uploading Your Git History to the Cloud](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/) — *blog.ferstar.org*
...
- [Google illegally retains customer data,and I am taking legal action against them](https://medium.com/@istokovicsgyorgy79/google-illegally-retains-customer-data-and-i-am-taking-legal-action-against-them-7da0cf95941c) — *medium.com*
...
- [GrapheneOS accuses Google of gatekeeping Android 17 features and security fixes](https://www.androidauthority.com/grapheneos-android-17-qpr1-security-patches-comments-3712218/) — *androidauthority.com*
...
- [North Korea's fake job interviews infected 30,000 devices](https://www.theregister.com/security/2026/09/18/north-koreas-fake-job-interviews-infected-30000-devices/5297461) — *theregister.com*
...
- [FBI: Fake cop and government impersonation scams cost victims $1.6B](https://www.theregister.com/cyber-crime/2026/09/18/fbi-fake-cop-and-government-impersonation-scams-cost-victims-16b/5297499) — *theregister.com*
...
- [This Android malware is nuts: it connects to your phone like a developer, but from the inside](https://cybernews.com/security/android-malware-uses-adb-from-inside/) — *cybernews.com*
...
- [Apple changes the way some apps ask users for permission to track them in Europe](https://cybernews.com/tech/apple-apps-tracking-europe/) — *cybernews.com*
...
- [Secure Messaging and AI Remain In Conflict Despite the Promise of TEEs](https://www.eff.org/deeplinks/2026/09/secure-messaging-and-ai-remain-conflict-despite-promise-tees) — *eff.org*
...
- [Infillion to acquire Foursquare, which will remain an independent brand](https://www.axios.com/2026/09/18/infillion-acquires-foursquare-location-data) — *axios.com*
...
- [~$18B Oracle New Mexico data center debt stressed amid delays, local pushback](https://www.ft.com/content/bd441859-6c94-4874-894f-9362c1703127?accessToken=zwAAAaC2qpAgkdO9RBhZbJRIdNOJT5NiwXAxJw.MEQCIF2GTIvPrQR34CxTSrXFXdSTutroNevJwWZldjypgJhGAiBVh2FgXIfxQ4D1rsycWQoF21_k03vTrmHMfIOELh4uqA&amp;sharetype=gift&amp;token=214b5825-e6b7-4144-8700-e405b7354614&amp;syn-25a6b1a6=1) — *ft.com*
...
- [Leaked: OpenAI sees -$278B FCF in 2026-2030; revenue $36B this year to $350B by 2030 (FT)](https://www.ft.com/content/6011d061-eee3-4193-b3b7-8ee4155f538c?accessToken=zwAAAaC26G0Nkc9gEdBh7uNBk9Ozt47kFV9TjA.MEQCIH_NhYE7F9hUSDoVhMKWDXlRF3xgIMstpfyu8BV8VlnFAiACGmurmMmekLhQHY7niCRm6LhfPNxOctJGSelJuguE6A&amp;sharetype=gift&amp;token=f3b46a30-cbcd-4e56-840e-e33d4eaeb5a7) — *ft.com*
...
- [Anthropic plans Nov IPO, later than expected; decision predates ex-researcher Jacob Coxon exit (WSJ)](https://www.wsj.com/tech/ai/anthropic-shifts-planned-ipo-to-november-8874dffc?st=9H74nC&amp;reflink=desktopwebshare_permalink) — *wsj.com*
...
- [Angle Health, AI benefits for small businesses, raises $600M led by Vitruvian at $2.7B valuation](https://www.wsj.com/pro/private-equity/ai-startup-angle-health-lands-600-million-for-2-7-billion-valuation-df77de76) — *wsj.com*
...
- [Anthropic, Accenture partner to embed evaluators; $2B+ investment over five years](https://www.anthropic.com/news/accenture-embedded-evaluation) — *anthropic.com*
...
- [London AI infra firm Nscale files for US IPO; H1 revenue up 1,252% to $140.6M, net loss $1.02B](https://www.cnbc.com/2026/09/18/nscale-ai-cloud-provider-ipo-nscl.html) — *cnbc.com*
...
- [Singapore-licensed dtcpay raises $25M Series A for stablecoin payments (CoinDesk)](https://www.coindesk.com/markets/2026/09/18/sbi-group-backs-payments-firm-dtcpay-in-usd25-million-funding-round) — *coindesk.com*
...
- [Sony Music, UMG sue Suno over WMG/BMG model based on copyright-infringing model](https://variety.com/2026/music/news/sony-music-universal-music-sue-suno-label-backed-model-1236866921/) — *variety.com*
...
- [Disney names ex-Character.AI CEO Karandeep Anand first CTO; had accused it of copyright infringement](https://variety.com/2026/biz/news/disney-cto-karandeep-anand-character-ai-1236866528/) — *variety.com*
...
- [Mind raises $72M Series B at $300M valuation for AI data loss prevention agents, total $112M](https://www.calcalistech.com/ctechnews/article/hklf44yygl) — *calcalistech.com*
...
- [Beijing's Naive AI valued at $1.4B+ after raising $400M; first LLM due as early as September](https://www.theinformation.com/articles/tsinghua-professors-stealth-llm-startup-hits-1-4-billion-valuation) — *theinformation.com*
...
- [SK Hynix launches SK Hynix Ventures in Silicon Valley to fund AI, data centers, optical interconnect](https://www.koreaherald.com/article/10878747) — *koreaherald.com*
...
- [Sources: ECB's Lagarde asked Greece to block Binance's MiCA license in June to protect digital euro](https://www.wsj.com/finance/currencies/christine-lagarde-helped-block-binances-foothold-in-europe-d905c86d) — *wsj.com*
...
- [Revolut CEO says fintech exploring dual New York and London listing, after dismissing UK](https://www.ft.com/content/ee1b5a66-24f2-49b8-b26f-895644ebe3f1) — *ft.com*
...
- [CFTC exempts 'passive software' from broker registration if no user assets (crypto/prediction mkts)](https://www.bloomberg.com/news/articles/2026-09-17/cftc-to-expand-crypto-predictions-trading-via-online-platforms) — *bloomberg.com*
...
- [World rolls out World Money, self-custodial super app in 150+ countries for stablecoin payments.](https://www.theblock.co/news/business/2026-09-17-world-launches-world-money-super-app-stablecoins-stripe-integration-boosted-rewards-415394) — *theblock.co*
...
- [CSS-Tricks could be a co-op](https://ericwbailey.website/published/css-tricks-could-be-a-co-op/) — *ericwbailey.website*
...
- [Uber ordered to pay $40M over death of woman left on Southern California freeway](https://ktla.com/news/california/uber-driver-abandoned-rider-freeway/) — *ktla.com*
...
- [I Hate Workday](https://nelson.cloud/i-hate-workday/) — *nelson.cloud*
...
- [Senior Engineers Are the Next DRAM Shortage](https://blog.herlein.com/post/build-another-engineer/) — *blog.herlein.com*
...
- [DigitalOcean has $3M for DHH and nothing for CSS-Tricks](https://keith.is/post/digitalocean-and-css-tricks/) — *keith.is*
...
- [US Treasuries Have Become Unappetizing for Foreign Central Banks and Governments](https://wolfstreet.com/2026/09/17/treasuries-have-become-badly-unappetizing-for-foreign-central-banks-governments/) — *wolfstreet.com*
...
- [Waymo in Singapore](https://waymo.com/waymo-in-singapore/) — *waymo.com*
...
- [AWS now supports spend limits](https://docs.aws.amazon.com/accounts/latest/reference/create-spend-limit.html) — *docs.aws.amazon.com*
...
- [Microsoft fixes the fix that broke Excel paste – partly](https://www.theregister.com/software/2026/09/18/microsoft-fixes-the-fix-that-broke-excel-paste-partly/5297467) — *theregister.com*
...
- [Former Labour deputy Tom Watson joins Palantir as £330M NHS deal nears break point](https://www.theregister.com/public-sector/2026/09/18/former-labour-deputy-tom-watson-joins-palantir-as-330m-nhs-deal-nears-break-point/5297426) — *theregister.com*
...
- [KPMG tech cuts come with a severance sum some staff call insulting](https://www.theregister.com/channel/2026/09/18/kpmg-tech-cuts-come-with-a-severance-sum-some-staff-call-insulting/5296942) — *theregister.com*
...
- [AI risks make some insurers wary of corporate liability](https://www.theregister.com/ai-and-ml/2026/09/18/ai-risks-make-some-insurers-wary-of-corporate-liability/5297347) — *theregister.com*
...
- [Saving another 100TB of RAM with math (and Rust)](https://blog.cloudflare.com/saving-100-tb-of-ram-with-math/) — *blog.cloudflare.com*
...
- [The Bikeshed email — PHKs Bikeshed](https://phk.freebsd.dk/sagas/bikeshed/) — *phk.freebsd.dk*
...
- [Wine 11.18 Continues Building Out Its NTOSKRNL Implementation](https://www.phoronix.com/news/Wine-11.18-Released) — *phoronix.com*
...
- [Steam Frame Making Use Of Zink For OpenGL On Vulkan](https://www.phoronix.com/news/Steam-Frame-Uses-Zink) — *phoronix.com*
...
- [Google's "Painful To Maintain" Binder C Linux Driver Being Removed In Favor Of Rust](https://www.phoronix.com/news/Google-Binder-C-Goodbye) — *phoronix.com*
...
- [Apple Video Decode Driver Posted For Upstream Linux Kernel Review](https://www.phoronix.com/news/Apple-Video-Decode-AVD-Linux) — *phoronix.com*
...
- [AMD Strix Halo Enjoys Some Performance Gains On Ubuntu 26.10, Especially With amd64v3](https://www.phoronix.com/review/ubuntu-2610-strix-halo) — *phoronix.com*
...
- [Linux Ready With Fix For Intel's FRED Crashing Some Games Under Wine / Steam Play](https://www.phoronix.com/news/Linux-FRED-Fix-For-Wine-Games) — *phoronix.com*
...
- [Ubuntu 26.10 Desktop Adjusting Its Behavior Under Memory Pressure](https://www.phoronix.com/news/Ubuntu-26.10-OOM-Adjustments) — *phoronix.com*
...
- [Linux Kernel Build Times Ready To Be Significantly Reduced With Latest Patches](https://www.phoronix.com/news/Linux-Kbuild-Faster-v3) — *phoronix.com*
...
- [AMD Sends In More HDMI FRL Updates For Linux 7.4, Fixes For Upcoming Hardware](https://www.phoronix.com/news/More-AMDGPU-For-Linux-7.4) — *phoronix.com*
...
- [Help Linux Hardware Testing & Reviews Continue While Enjoying Phoronix Without Ads](https://www.phoronix.com/news/Phoronix-Oktoberfest-2026) — *phoronix.com*
...
- [Valve has open-sourced Lepton, its tool to bring Android games to Steam](https://www.theverge.com/tech/997315/valve-has-open-sourced-lepton-its-tool-to-bring-android-games-to-steam) — *theverge.com*
...
- [Systemd is a suite of basic building blocks](https://brand.systemd.io/) — *brand.systemd.io*
...
- [BeanShell3 in Development](https://beanshell.github.io/home.html) — *beanshell.github.io*
...
- [OpenJev](https://openjev.com/) — *openjev.com*
...
- [KDE turns 30 and someone's brought an AI-native desktop proposal](https://www.theregister.com/software/2026/09/18/kde-turns-30-and-someones-brought-an-ai-native-desktop-proposal/5297282) — *theregister.com*
...
- [Vale, code-like linting for prose](https://vale.sh) — *vale.sh*
...
- [awesome-tunneling: List of tunneling software and services](https://github.com/anderspitman/awesome-tunneling) — *github.com*
...
- [FAQ: Why isn’t mutable a subtype of immutable, or vice versa?](https://crumbles.blog/posts/2026-09-17-immutable-mutable.html) — *crumbles.blog*
...
- [Benchmarking Wild vs Mold](https://davidlattimore.github.io/posts/2026/09/18/benchmarking-wild-vs-mold.html) — *davidlattimore.github.io*
...
- [The C++20’s u8/char8_t Backward-Compatibility Fiasco](https://giodicanio.com/2026/09/11/the-c-plus-plus-20-s-u8-char8_t-fiasco/) — *giodicanio.com*
...
- [OpenCL 3.1.2 Released With cl_khr_command_buffer Promoted](https://www.phoronix.com/news/OpenCL-3.1.2-Released) — *phoronix.com*
...
- [How did AMD Ryzen get 50% faster in two years?](https://lemire.me/blog/2026/09/18/how-did-amd-ryzen-get-50-faster-in-two-years/) — *lemire.me*
...
- [Apple releases iPhone Duo simulator and Xcode 27.1 beta](https://developer.apple.com/documentation/xcode-release-notes/xcode-27_1-release-notes) — *developer.apple.com*
...
- [Jeff – A read-only CLI for semantic code review using Jev](https://github.com/Alurith/jeff) — *github.com*
...
- [We made Playwright 2x faster and 80% more token efficient](https://github.com/browserbase/stagehand) — *github.com*
...
- [Build Faster Feedback Loops Using Qualitative User Research](https://blog.nseldeib.com/p/build-faster-feedback-loops-using) — *blog.nseldeib.com*
...
- [Rickub – The Smartest Git in the Universe](https://rickub.com/) — *rickub.com*
...
- [Code Scans](https://devin.ai/blog/introducing-code-scans) — *devin.ai*
...
- [Goose: 1.16x faster than C++ and 1.12x than safe Rust, while memory safe](https://github.com/aardappel/goose/tree/master) — *github.com*

### Claude Code revamps projects so you can work and pay in parallel

Claude Code has revamped its projects feature to allow multiple Claude sessions to run in parallel. This means users can work without waiting as long to hit usage limits when running several sessions at once.

- [Claude Code revamps projects so you can work and pay in parallel](https://www.theregister.com/ai-and-ml/2026/09/18/claude-code-revamps-projects-so-you-can-work-and-pay-in-parallel/5297532) — *theregister.com*
...
- [Admins, you've been warned: The clock is ticking on Edge's IE Mode](https://www.theregister.com/software/2026/09/18/admins-youve-been-warned-the-clock-is-ticking-on-edges-ie-mode/5297408) — *theregister.com*
...
- [The ideal database for AI agents doesn't exist yet, says Percona CEO](https://www.theregister.com/databases/2026/09/18/the-ideal-database-for-ai-agents-doesnt-exist-yet-says-percona-ceo/5296906) — *theregister.com*
...
- [AWS confesses its console causes cloudy confusion for new users](https://www.theregister.com/off-prem/2026/09/18/aws-confesses-its-console-causes-cloudy-confusion-for-new-users/5297365) — *theregister.com*
...
- [US officials: Palantir Maven AI overreliance a factor in Iran strike killing 123 children](https://bloomberg.com/graphics/2026-iran-school-attack/?accessToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzb3VyY2UiOiJTdWJzY3JpYmVyR2lmdGVkQXJ0aWNsZSIsImlhdCI6MTc4OTc2NTUyNywiZXhwIjoxNzkwMzcwMzI3LCJhcnRpY2xlSWQiOiJUTEtWT01LR1pBSlgwMCIsImJjb25uZWN0SWQiOiJFQzUzMkU0NDM2OTc0ODRGOTJGOUY3MTdGQ0QzQUZBQiJ9.cevRBXkqlYKUN284O24VJs1DEdiK9NxSfe6mkcAyPEI) — *bloomberg.com*
...
- [Virginia Gov. Spanberger signs EO to slow data center approvals, create AI displacement task force](https://www.theverge.com/policy/997573/virginia-governor-spanberger-data-center-ai-task-force) — *theverge.com*
- [Virginia governor wakes up to fact datacenters have become political cancer](https://www.theregister.com/systems/2026/09/18/virginia-governor-wakes-up-to-fact-datacenters-have-become-political-cancer/5297561) — *theregister.com*
...
- [US "almost started a war" after AI hallucinated Chinese ship in Middle East carried nuke parts (CNN)](https://www.cnn.com/2026/09/18/politics/us-military-ai-false-intelligence-china-ship) — *cnn.com*
...
