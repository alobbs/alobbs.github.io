...
date: 2026-03-25 13:08:05.746284
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
Ubuntu plans to streamline its signed GRUB bootloader in version 26.10 to enhance security by removing support for various filesystems, image formats, and partition configurations. This change will require the `/boot` partition to be formatted as ext4, impacting users of encrypted `/boot` partitions and those utilizing unsupported filesystems. Affected systems will initially remain on the 26.04 LTS release.
...
HMRC has awarded Amazon Web Services a £473 million contract to migrate services from Fujitsu datacenters to AWS's cloud infrastructure. The deal, lasting up to ten years, leaves AWS as the sole bidder, raising concerns about limited negotiation power for the government. The migration aims to end HMRC's reliance on Fujitsu-managed datacenters by 2028.

- [HMRC hands £473M Fujitsu migration deal to AWS after competition melts away](https://go.theregister.com/feed/www.theregister.com/2026/03/25/hmrc_fujitsu_contract_aws/) — *go.theregister.com*

### Open source isn't a tip jar – it's time to charge for access

Open source projects are facing financial difficulties due to a lack of support from companies benefiting from their code, leading to developer burnout and underfunded infrastructure. A proposed solution involves charging commercial users for access while still keeping the core code freely available. This shift aims to ensure the sustainability of open source development and address the increasing burden on essential registries.
...
### Temu Owner PDD Revenue Up, Profit Falls Short of Estimates

PDD, the parent company of Temu, reported a 12% year-over-year revenue increase to $18 billion for Q4 2023. However, net profit declined 11% to $3.56 billion, falling short of analyst expectations. The company cited efforts to retain merchants as a factor impacting its financial performance.

- [Temu Owner PDD Revenue Up, Profit Falls Short of Estimates](https://www.wsj.com/business/earnings/temu-owner-pdd-posts-surprise-profit-drop-83d81536?st=aQND2p&amp;reflink=desktopwebshare_permalink) — *wsj.com*
...
### NoTraffic raises $90M to optimize traffic flow with AI

NoTraffic, a Kansas-based company using AI to optimize traffic flow, has secured a $90 million Series C funding round led by PSG Equity. The platform leverages sensor data and AI to improve intersection traffic management and reduce congestion. This investment will help expand the company's reach and further develop its technology.

- [NoTraffic raises $90M to optimize traffic flow with AI](https://www.axios.com/pro/enterprise-software-deals/2026/03/24/notraffic-90m-psg-series-c) — *axios.com*

### OpenAI Hires JioStar CEO to Lead Asia-Pacific Operations

OpenAI has appointed Kiran Mani, formerly CEO of JioStar, to lead its Asia-Pacific operations in a newly created position. Mani will report to OpenAI's Chief Security Officer, Jason Kwon. This expansion signals OpenAI's growing focus on the Asia-Pacific market.

- [OpenAI Hires JioStar CEO to Lead Asia-Pacific Operations](https://www.bloomberg.com/news/articles/2026-03-25/openai-hires-ceo-of-india-s-jiostar-to-head-up-asia-pacific) — *bloomberg.com*

### OpenAI's Next Model Ready, Simo Leads AGI Deployment

OpenAI has discontinued its Sora video generation project, citing a need to reallocate GPU resources towards other priorities like Codex and a new super-app strategy. CEO Sam Altman announced a reorganization shifting safety and security responsibilities and appointed Fidji Simo as CEO of "AGI Deployment," while also revealing the completion of pretraining for the next model, codenamed Spud. The move signals a shift in focus away from immediate content creation towards longer-term research and large-scale AI deployment.

- [OpenAI's Next Model Ready, Simo Leads AGI Deployment](https://sources.news/p/why-openai-killed-sora) — *sources.news*
