...
date: 2026-04-21 20:12:04.940500
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
CISA has added three Cisco SD-WAN vulnerabilities to its known exploits catalog due to active attacks, requiring urgent federal patches. In cybersecurity, a former ransomware negotiator pleaded guilty to aiding the ALPHV/BlackCat gang, while the "StealkTok" campaign has infected over 130,000 users. Meanwhile, Oracle's database dominance is eroding as cloud and AI-driven providers gain ground.
...
### ChatGPT Images 2.0 improves non-Latin text rendering in Japanese, Korean, Hindi, and Bengali

OpenAI has launched ChatGPT Images 2.0, a new model featuring "thinking capabilities" that significantly improve text rendering, fine details, and complex compositions. The update also provides enhanced support for non-Latin text in languages such as Japanese, Korean, Hindi, and Bengali.
...
### OpenAI's ChatGPT Images 2.0 adds web search and 'thinking' to create multiple images per prompt

OpenAI has released ChatGPT Images 2.0, introducing new “thinking capabilities” that allow the AI to search the web to assist in the image generation process. The update enables the creation of up to eight consistent images from a single prompt and features improved text rendering, higher resolutions, and a wider variety of aspect ratios.
...
CISA has added three Cisco Catalyst SD-WAN Manager vulnerabilities to its Known Exploited Vulnerabilities Catalog due to active exploitation. Federal agencies have been directed to patch these security flaws, which include risks of information disclosure and arbitrary file overwriting, by Thursday.
...
### New Malware and Spyware Threats

Recent cyberattacks are using social engineering and malicious extensions to compromise user data across various platforms. The "ClickFix" campaign utilizes fake CAPTCHA prompts to deliver AppleScript stealers to macOS users, while the "StealkTok" campaign has infected over 130,000 users through fraudulent TikTok video downloader extensions on Chrome and Edge.

- [macOS ClickFix attacks deliver AppleScript stealers to snarf credentials, wallets](https://go.theregister.com/feed/www.theregister.com/2026/04/21/macos_clickfix_attacks_deliver_applescript/) — *go.theregister.com*
...
Angelo Martino, a former ransomware negotiator at DigitalMint, has pleaded guilty to assisting the ALPHV/BlackCat gang by leaking confidential information to maximize ransom payments from U.S. companies. He also admitted to conspiring with two co-workers to deploy ransomware payloads against multiple victims for personal profit.

- [Yet another ex-ransomware negotiator admits turning rogue after payoff from crimelords](https://go.theregister.com/feed/www.theregister.com/2026/04/21/yet_another_ex_ransomware_negotiator_pleads/) — *go.theregister.com*
...
The Firefox team utilized Anthropic's Claude Mythos Preview to identify and patch 271 security vulnerabilities in the Firefox 150 release. This use of frontier AI models aims to close the gap between human and machine-discoverable bugs, shifting the security advantage from attackers back to defenders.
...
As LLMs advance in logical inference and pattern matching, there is a growing concern that they could be used to discover numerous unpatchable zero-day vulnerabilities. The author suggests that traditional security measures like airgapping may eventually become ineffective, potentially necessitating a shift toward more primitive technologies to avoid manipulation.
...
Framework is showcasing its lineup of customizable and repairable computing products, including the new Laptop 13 Pro and the graphics-upgradeable Laptop 16. The collection also features a compact 4.5L desktop and a 12.2-inch convertible laptop, all designed for easy hardware upgrades to promote long-term usability.

- [Framework 13 Pro](https://frame.work) — *frame.work*

### Framework Laptop 13 Pro

The Framework Laptop 13 Pro features Intel Core Ultra Series 3 processors and offers up to 20 hours of battery life in a durable CNC aluminum chassis. Designed for longevity, the device maintains a focus on repairability and upgradability through customizable expansion ports and support for LPCAMM2 memory.

- [Framework Laptop 13 Pro](https://frame.work/laptop13pro) — *frame.work*
