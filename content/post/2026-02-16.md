...
date: 2026-02-16 18:03:55.172348
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
The European Parliament has blocked AI features on lawmaker devices due to cybersecurity concerns, while Nexo crypto lender has re-launched in the US with Bakkt partnership. India is promoting its frugal AI strategy to address local issues, and Byju's founder faces allegations of siphoning $533M from a loan. Apple is set to announce new products at an event on March 4, and Samsung's Galaxy S26 series features a "Zero-peeking" camera feature. US productivity rose by 2.7% in 2025, while OpenAI has retired its AI model GPT-40 amid fan backlash.
