...
date: 2026-02-16 17:48:12.330888
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
In a day marked by cybersecurity concerns, the European Parliament has blocked AI features on lawmakers' work devices due to data protection fears. Meanwhile, Nexo, a crypto lender, has re-launched in the US after a three-year absence following a $45M fine settlement with SEC charges. India is poised to host an AI Impact Summit focusing on frugal AI strategies for local solutions. The tech sector faces challenges, including allegations that Byju's founder siphoned millions from a loan and concerns over Apple's upcoming event featuring new products. Fractal Analytics raised $313 million despite weak Indian IPO market, while Samsung showcases its "Zero-peeking" camera feature in its new Galaxy S26 ads.
...
Researchers from ETH Zurich and Università della Svizzera italiana found vulnerabilities in the zero-knowledge encryption of popular password managers Bitwarden, LastPass, and Dashlane, exposing user credentials even if servers are compromised. The researchers tested the password managers' ability to keep secrets safe under various attack scenarios and found that Bitwarden was most susceptible to attacks, with 12 out of 12 attempts successful. This highlights a need for vendors to ensure new users have access to latest cryptographic standards by default.
