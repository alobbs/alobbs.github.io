...
date: 2026-09-13 05:34:50.229668
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
Revolut confirmed it gave sensitive customer data—IDs, statements, transactions—to scammers using a legitimate government email domain, but says funds were untouched. The Atlantic reached Sept. 12 with no hurricane for the first time since 1966, a 60-year record, as El Niño likely suppresses storms. Sam Altman and Dario Amodei agreed the AI industry must "pace the frontier," with outside evaluators granted access to verify safety.
