...
date: 2026-09-13 04:01:43.731118
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
Revolut confirmed it gave sensitive customer data—IDs, transactions, IBANs—to scammers who used a legitimate government email domain; funds were safe. The Atlantic set a 60-year record with no hurricane by Sept. 12, linked to El Niño. Altman and Amodei agreed AI must “pace the frontier,” with third-party safety evaluators. California still only requires $30K driver coverage despite $1.6M average fatality cost.
...
### Q&A with AI researchers Schulman, Millidge, O'Neill on anti-RSI case, Chinese labs, long-horizon RL

Dwarkesh Patel hosted a Q&A with AI researchers John Schulman, Beren Millidge, and Charlie O'Neill on the Dwarkesh Podcast. They discussed steelmanning the case against recursive self-improvement, Chinese labs’ progress, long-horizon RL, automated AI researchers, the sim-to-real gap, and rapid-fire timelines.

- [Q&A with AI researchers Schulman, Millidge, O'Neill on anti-RSI case, Chinese labs, long-horizon RL](https://www.dwarkesh.com/p/john-beren-charlie) — *dwarkesh.com*
