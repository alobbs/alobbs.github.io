...
date: 2026-06-01 19:55:47.129179
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
The UK is deploying the Royal Navy to protect subsea cables from Russian submarine activity. Cybersecurity alerts are high as attackers exploit a Palo Alto VPN flaw and launch brute-force attacks on Dashlane. Additionally, major breaches have hit Bumble and Atlas Menu users. Finally, a memory shortage is pushing PC prices up by 11% as chipmakers pivot focus toward AI server components.
...
### Malicious npm packages target Red Hat services

Researchers have identified malware in @redhat-cloud-services npm packages that targets credentials for AWS, GCP, and GitHub. These malicious packages can function as self-propagating worms, but the affected versions have been identified and updated to mitigate the security risk.
...
Developers have announced the first release of `libzstd-rs-sys`, a pure-Rust implementation of the Zstandard compression format. The project aims to provide a portable, drop-in replacement for the C reference library, simplifying use on platforms such as WebAssembly and Windows. While decompression and dictionary building are currently functional, the implementation of the compression encoder is the project's next major milestone.
...
### Endra raises $50M led by a16z to automate plumbing and electrical wiring design

Stockholm-based startup Endra has raised $50 million in a funding round led by Andreessen Horowitz. The company specializes in automating the design of plumbing and electrical wiring for new buildings.

- [Endra raises $50M led by a16z to automate plumbing and electrical wiring design](https://www.axios.com/pro/enterprise-software-deals/2026/06/01/endras-engineer-buildings-ai) — *axios.com*

### Bernie Sanders calls for sovereign wealth fund with AI stakes to benefit humanity.

Senator Bernie Sanders has proposed the American A.I. Sovereign Wealth Fund Act to ensure that the wealth generated by artificial intelligence benefits the public rather than a small group of billionaires. The legislation seeks to create a sovereign wealth fund through a one-time 50 percent tax on the stock of the nation's largest AI companies.

- [Bernie Sanders calls for sovereign wealth fund with AI stakes to benefit humanity.](https://www.nytimes.com/2026/06/01/opinion/artificial-intelligence-bernie-sanders.html?unlocked_article_code=1.m1A.20uD.iX08KzC_HkXx&amp;smid=url-share) — *nytimes.com*

### Florida AG sues OpenAI and Sam Altman, seeking personal liability for deceptive trade practices

Florida Attorney General James Uthmeier has sued OpenAI and CEO Sam Altman, seeking to hold Altman personally liable for deceptive trade practices, negligence, and public nuisance. The lawsuit alleges that the company prioritized profits over user safety and failed to disclose risks such as addiction, violence, and potential harm to individuals.

- [Florida AG sues OpenAI and Sam Altman, seeking personal liability for deceptive trade practices](https://www.nbcnews.com/tech/tech-news/florida-sues-openai-sam-altman-saying-put-profit-safety-rcna347602) — *nbcnews.com*
