...
date: 2026-09-21 03:40:19.303017
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
Windows updates remain painful: a dormant PC spent seven hours updating. Linux 7.3-rc4 arrived with AI/LLM-caught fixes plus critical x86 patches for Intel microcode, FRED crashes, and APX. Gzip 1.15 landed 100+ commits fixing long-standing bugs, including corruption and a buffer overflow. Meanwhile, a report describes a firm where Claude Code writes all specs, code, tests, and tickets, yet engineers just press enter and nobody reads output.
