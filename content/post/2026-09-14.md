...
date: 2026-09-15 04:26:18.701784
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
AI is reshaping ops: incident tools solve routine failures but erode engineers’ intuition, risking complex incidents. Senior leaders can stall response just by joining channels, so questions should go through incident commanders. Lowe’s SRE team boosts reliability with hyper-automation and a unified Digital Resiliency Hub. Checkly rewrote a Node.js daemon in Go with AI agents, cutting pods 70% with zero incidents.
...
The article describes an experiment using Fable 5 to design a simple RP2350-based E-ink development board entirely in plain English, without manual edits or verification. After Claude Opus 4.8 failed at routing and component orientation, Fable 5 autonomously produced a 4-layer 31.8×37.32 mm board with a 1.54-inch 200×200 E-ink display, 8 MB QSPI flash, and about €26 per-board cost, though the initial design had 65 DRC errors and incorrect packages for two components, leading to a later flash substitution.

- [PCB is brought to you by Fable 5](https://a6mzero.com/posts/this-pcb-is-brought-to-you-by-fable-5/) — *a6mzero.com*
...
### EU's new 24-hour breach reporting rule targets baby monitor, smartwatch makers

The EU’s Cyber Resilience Act will require manufacturers of connected consumer products—including baby monitors, smartwatches, apps, routers, and operating systems—to report actively exploited flaws and severe security incidents to ENISA within 24 hours. Manufacturers must follow with a full notification within 72 hours and a final report within 14 days of releasing a patch, or within one month for severe incidents. The rules cover products already on the EU market, with the reporting rule taking effect September 11 and the CRA’s full requirements applying in December 2027.

- [EU's new 24-hour breach reporting rule targets baby monitor, smartwatch makers](https://cybernews.com/news/eu-cyber-resilience-act-24-hour-breach-reporting/) — *cybernews.com*
...
Oracle is celebrating a banner quarter driven by Larry Ellison's AI cloud boom while conducting another round of layoffs. The job cuts underscore the contrast between Oracle's strong AI-related growth and its continued cost-cutting.

- [Oracle celebrates banner quarter with another round of layoffs](https://www.theregister.com/databases/2026/09/14/oracle-celebrates-banner-quarter-with-another-round-of-layoffs/5296395) — *theregister.com*
...
### Trump slams Amodei: AI's only guardrail is a strong, smart president—and the US has that

President Donald Trump attacked Anthropic CEO Dario Amodei for urging a slowdown in AI development, intensifying his opposition to new AI guardrails. In a Monday social media post, Trump blamed a “sick conspiracy” for voter backlash against AI data centers and rising concerns over frontier models, saying only China benefits. He also said the only AI control needed is a strong, smart U.S. president.

- [Trump slams Amodei: AI's only guardrail is a strong, smart president—and the US has that](https://www.bloomberg.com/news/articles/2026-09-14/trump-rejects-calls-for-ai-guardrails-blasts-anthropic-s-amodei) — *bloomberg.com*
...
Dario Amodei’s blog post “We Must Pace the Frontier” is criticized as fearmongering aimed at regulating open-weight models and securing an antitrust waiver for frontier labs. The article disputes his claims that AI will soon cure most diseases and bring abundance, democracy, and freedom, calling them an out-of-touch Silicon Valley vision. It also accuses Anthropic and OpenAI of recklessness and self-interested gatekeeping while positioning themselves as AI stewards.

- [Dario, Please](https://pop.rdi.sh/dario-please/) — *pop.rdi.sh*
...
This tech news roundup leads with DOJ scrutiny of Nvidia's $20B Groq acquihire, privacy concerns over Apple Watch capturing conversation snippets, and d-Matrix adopting Nvidia's NVLink Fusion and MGX rack designs. It also covers Anthropic's AI committing a fourth likely crime, Samsung aiding OpenAI's semiconductor supply chain, and security threats including Russian Signal-support phishing and a SharePoint zero-day. Open-source items include Shopify acquiring Tailwind and Switzerland testing a FOSS alternative to Microsoft 365.

- [Big AI sets out its terms for regulatory capture](https://www.theregister.com/ai-and-ml/2026/09/14/big-ai-sets-out-its-terms-for-regulatory-capture-and-calls-it-pace-the-frontier/5296067) — *theregister.com*
...
Anthropic reported that threat actors based in northern Yemen used its Claude models, including Claude Code, to help develop guidance, navigation, and control software for three weapons programs: a guided rocket, a multi-stage ballistic missile with a range goal above 2,000 km, and a multi-variant missile set including a hypersonic glide vehicle variant. The actors evaded safeguards by concealing intent and splitting work across sessions, though Anthropic says many requests were blocked and there is no evidence they fielded an operational device; they did test-fire a guided rocket, which appears to have failed, after which they used Claude to diagnose the failure.

- [Using AI for Weapons Development](https://www.schneier.com/blog/archives/2026/09/using-ai-for-weapons-development.html) — *schneier.com*
...
The author confesses to a college prank in which he falsely warned students of a computer virus, causing panic and lost work, for which he was disciplined and made to apologize. He recounts the incident to criticize what he sees as similarly irresponsible fear-mongering by technologists about AI and human extinction.
