...
date: 2026-03-16 19:00:30.087856
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
Samsung Galaxy Book users are experiencing data access problems after a bug in the Galaxy Connect app, prompting Microsoft to remove it from its store and Samsung to offer a temporary fix. Meanwhile, the UK is investing £45 million in an AI supercomputer to accelerate fusion energy research, while West Sussex County Council’s Oracle software rollout faces further delays and a ballooning cost of over £41 million. MPs are criticizing the slow pace of redress for Post Office Horizon scandal victims, noting Fujitsu hasn’t contributed financially. Finally, Microsoft has paused Copilot integration due to technical problems.
