...
date: 2026-07-01 19:06:31.920008
draft: false
categories: [ "Briefing" ]
params:
  math: false
...
Pidgin 3.0 Alpha 2 adds notifications, avatar, and QR support but is only for developers. Asahi Linux 7.1 fixes macOS 27-induced boot and battery issues. Box3D, an open-source physics engine forked from Box2D, addresses Unreal Engine limitations. Zig moved package management from compiler to build system, reducing binary size by 4%. A passive Ethernet tap built for €10 reliably captured smart TV traffic.
...
SpudCell is the first synthetic cell constructed entirely from non-living chemical components that can perform a complete cell cycle, including growth, genome replication, division, and selection across generations. It uses a 90,000 base pair genome, 36 purified enzymes, and a lipid membrane, growing by fusing with feeder liposomes under genetic control. Built bottom-up, it demonstrates evolution through competition among genetic variants.

- [SpudCell: The first synthetic cell with a complete cell cycle](https://biotic.org/research/spudcell/) — *biotic.org*

### For first time, a cell built from scratch grows and divides

Scientists have created a synthetic cell, called the spudcell, that can grow and divide for the first time. This milestone in synthetic biology marks a step toward building fully artificial life from scratch.
...
Researchers at the University of Minnesota have created synthetic cells called SpudCells that can feed, grow, reproduce, and compete for food, exhibiting most hallmarks of life though not yet considered fully alive. This breakthrough advances the understanding of minimal life and could eventually lead to engineered applications such as novel medicines or carbon capture.
